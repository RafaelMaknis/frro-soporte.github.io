...
if ENVIRONMENT == 'PRODUCTION':
    SITEURL = 'https://frro-soporte.github.io'
else:
    SITEURL = 'http://localhost:5500'
    RELATIVE_URLS = True

AUTHOR = 'Cátedra de Soporte a la gestión de Datos con Programación visual'
AUTHOR_EMAIL = ''
AUTHOR_AVATAR = r''
SITESUBTITLE = ''
SITENAME = 'Showcase Oficial de la Cátedra Soporte - UTN FRRo'
SITEIMAGE = r''
...
PLUGINS = [
    ...
    'sitemap', 'bundler_cache_busting', 'blur_thumbnails', 
]
